...
export default function Profile() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row items-start justify-center gap-10 px-4 py-10 bg-gray-100">
            <div className="w-full max-w-xs bg-white p-6 rounded-xl shadow">
                <div className="flex flex-col items-center">
                    ...
                    <Link
                        to="/myprofile/update"
                        className="mt-4 w-full text-center bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition"
                    >
                        Edit Profile
                    </Link>
                </div>
            ...
            <div className="w-full max-w-xl bg-white p-6 rounded-xl shadow space-y-4">
                ...
                <div>
                    ...
                    <p className="text-lg font-semibold text-gray-800">{String(user.createdAt).substring(0, 10)}</p>
                </div>
