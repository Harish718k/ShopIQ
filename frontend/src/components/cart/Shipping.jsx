  ...
  return (
    <Fragment>
      ...
      <div className="flex justify-center items-start py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8 bg-white shadow-xl rounded-2xl p-8 border">
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <div>
              <label htmlFor="city_field" className="block text-sm font-medium text-gray-700">
                City
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="postal_code_field" className="block text-sm font-medium text-gray-700">
                Postal Code
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="country_field" className="block text-sm font-medium text-gray-700">
                Country
              </label>
              <select
                id="country_field"
            ...
            <div>
              <label htmlFor="state_field" className="block text-sm font-medium text-gray-700">
                State
              </label>
              <input
                type="text"
